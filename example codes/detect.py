...
class detectUsb:
    def __call__(self):
        ...
        self.devClass = usb.core.find(bDeviceClass=BDeviceClass)
        self.printers = usb.core.find(find_all=True, bDeviceClass=BDeviceClass)
        ...
        #     try:
        #         self.ret = dev.ctrl_transfer(0xC0, bRequest, 0, 0, 1)
        ...
        # self.alternate_setting = usb.control.get_interface(dev,interface_number)
        # self.intf = usb.util.find_descriptor(cfg, bInterfaceNumber = interface_number, bAlternateSetting = alternate_setting)
        # self.alt = usb.util.find_descriptor(cfg, find_all=True, bInterfaceNumber=1)

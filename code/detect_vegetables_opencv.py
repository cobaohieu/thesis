...
class YOLOv4:
    ...
    def parse_arguments(self):
        ...
        parser.add_argument('--cfg', type=str, default='./vegetables/yolov4-tiny-custom.cfg', help='Path to cfg to use')
        parser.add_argument('--weights', type=str, default='./vegetables/yolov4-tiny-custom_vegetables.weights', help='Path to weights to use')
        parser.add_argument('--namesfile', type=str, default='./vegetables/yolo.names', help='Path to names to use')
    ...
    def stream_inf(self):
        ...
        while(source.isOpened()):
            ...
            if ret:
                ...
                cv2.imshow('Vegetables Detection Mode', frame)

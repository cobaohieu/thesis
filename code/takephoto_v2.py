...
class Ui_MainWindow(object):
	def setupUi(self, MainWindow):
		...
		self.filename = '/home/jetson/Pictures/C922/IMG_'+str(time.strftime("%Y-%b-%d at %H.%M.%S %p"))+'.png' # Will hold the image address location
		self.temp = None # Will hold the temporary image for display
	...
	def control_brightness(self,img,value):
	...
	def control_blur(self,img,value):
	...
	def update(self):
		...
		"""
		img = self.control_brightness(self.image,self.brightness_value_now)
		img = self.control_blur(img,self.blur_value_now)
	...
	def savePhoto(self):
		...
		self.filename = '/home/jetson/Pictures/C922/IMG_'+str(time.strftime('%Y-%b-%d at %H.%M.%S %p'))+'.png'
